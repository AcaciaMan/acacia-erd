...
exports.DescribeEntityPanel = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const nonce_1 = require("../utils/nonce");
class DescribeEntityPanel {
    static currentPanel;
    _panel;
    _extensionPath;
    _disposables = [];
    static createOrShow(extensionPath, entity) {
        ...
        if (DescribeEntityPanel.currentPanel) {
            ...
            const panel = vscode.window.createWebviewPanel('describeEntity', 'Describe Entity', column, {
                enableScripts: true,
    ...
    constructor(panel, extensionPath, entity) {
        this._panel = panel;
    ...
    _getHtmlForWebview(webview, entity) {
        const scriptPathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'resources', 'describe_entity.js'));
        const scriptUri = webview.asWebviewUri(scriptPathOnDisk);
        const stylePathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'resources', 'describe_entity.css'));
...
exports.DescribeEntityPanel = DescribeEntityPanel;
//# sourceMappingURL=DescribeEntity.js.map