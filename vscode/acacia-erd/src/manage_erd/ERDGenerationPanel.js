...
class ERDGenerationPanel {
    ...
    static createOrShow(extensionPath) {
        ...
        if (ERDGenerationPanel.currentPanel) {
            ...
            const panel = vscode.window.createWebviewPanel('erdGeneration', 'ERD Generation Parameters', column || vscode.ViewColumn.One, {
                enableScripts: true,
    ...
    _getHtmlForWebview(webview) {
        const scriptPathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'resources', 'erd_generation.js'));
        const scriptUri = webview.asWebviewUri(scriptPathOnDisk);
        const stylePathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'resources', 'erd_generation.css'));
    ...
    generateERD(parameters) {
        ...
        if (InteractiveERDPanel_1.InteractiveERDPanel.currentPanel) {
            (0, InteractiveERDPanel_1.chooseJSONFile)(InteractiveERDPanel_1.InteractiveERDPanel.currentPanel._panel.webview, parameters);
        }
        else {
...
exports.ERDGenerationPanel = ERDGenerationPanel;
//# sourceMappingURL=ERDGenerationPanel.js.map